!(function (u, D) {
            ...
            if (
              ...
              (D = (function (u, D) {
                ...
                if (
                  ...
                  return r;
                if ("function" == typeof (e = u.valueOf) && !t((r = e.call(u))))
                  return r;
                if (
                  !D &&
                  "function" == typeof (e = u.toString) &&
    ...
    d = u(function (u) {
      ...
      (e.inspectSource = function (u) {
        ...
        (u.exports = function (u, e, t, n) {
          ...
          C && (B(t, "name") || a(t, "name", e)),
            u[e] !== t &&
              (C && (B(t, r) || a(t, r, u[e] ? "" + u[e] : F.join(String(e)))),
              u === D
                ? (u[e] = t)
                : n
                ? u[e]
      ...
      function (u, D) {
        ...
        return F < 0 || F >= n
          ? h
            ? ""
            : void 0
          : (e = r.charCodeAt(F)) < 55296 ||
            e > 56319 ||
            F + 1 === n ||
            (t = r.charCodeAt(F + 1)) < 56320 ||
            t > 57343
          ? h
            ? r.charAt(F)
            : e
  ...
  m(m.S + m.F * (!!P && 1 != P.length), "String", {
    fromCodePoint: function (u) {
      for (
        var D, e, t, r = arguments, F = [], n = arguments.length, C = 0;
        n > C;
  ...
  function Du() {
    ...
    if (null !== u && "object" == typeof u)
      O.push(u),
        (I = Array.isArray(u) ? "beforeArrayValue" : "beforePropertyName");
    else {
      var e = O[O.length - 1];
      I =
        null == e
  ...
  function tu(u) {
    return Cu(
      void 0 === u
        ...
        : "JSON5: invalid character '" + nu(u) + "' at " + V + ":" + J
    );
  }
  function ru() {
    ...
    stringify: function (u, D, e) {
      ...
      if (
        (null == D ||
          "object" != typeof D ||
          Array.isArray(D) ||
          ((e = D.space), (F = D.quote), (D = D.replacer)),
        "function" == typeof D)
      )
        r = D;
        ...
        for (var i = 0, E = D; i < E.length; i += 1) {
          ...
          "string" == typeof o
            ...
            : ("number" == typeof o ||
                ...
                o instanceof Number) &&
              (a = String(o)),
            void 0 !== a && t.indexOf(a) < 0 && t.push(a);
        }
      }
      return (
        e instanceof Number
        ...
        return "string" == typeof e
          ...
          ? Array.isArray(e)
            ...
            : (function (u) {
                ...
                C += A;
                for (
                  var e, r, F = t || Object.keys(u), i = [], E = 0, o = F;
                  E < o.length;
                  E += 1
                ) {
                  var a = o[E],
